...
void TileMap::palette(int x, int y, int pal){
	va[4*(x+width*y)].color = sf::Color(pal,0,0);
	va[4*(x+width*y)+1].color = sf::Color(pal,0,0);
	va[4*(x+width*y)+2].color = sf::Color(pal,0,0);
	va[4*(x+width*y)+3].color = sf::Color(pal,0,0);
}
